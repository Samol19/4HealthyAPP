...
export const ChangeUsername = () => {
  ...
  //PROBAMOS CON EMAIL TEST
        if (canIn) {
            axios.put('https://api-library-v1.onrender.com/updateuser', { id:"1", username:password })
  ...
  return (
    ...
    <h1 className='w-1/2 pt-5 pl-20' > NOMBRE DE USUARIO: </h1>


    <div className='flex-row w-full items-end'>
 ...
 <button className='btn-primary mt-3 ml-auto'  type='submit' onClick={() => setShowModal(true)}>
                            Cambiar nombre</button> {showModal ? (
...
<div className="centered-box py-4 ">
<div >
<h1 className="restore-title">Establecer un nuevo nombre de usuario</h1>
<p >
    Establezca su nuevo nombre de usuario, recuerde introducir como minimo 4 caracteres.
</p>
<br />
<p className="email-label">Nuevo usuario</p>
<br />
<form name='restore' id='restore' className='flex flex-col gap-y-4'>
    <Input label="Nuevo usuario" helpText={passwordComp.helper}
